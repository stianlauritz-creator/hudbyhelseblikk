...
export interface BehandlingDetalj {
  ...
  /**
   * Forhåndsvelger behandler i timeboken når bare én utfører behandlingen,
   * f.eks. "/bestill-time?behandler=christina". Standard er timeboken med
   * alle behandlere.
   */
  bookingHref?: string;
...
export const BEHANDLINGER: BehandlingDetalj[] = [
  ...
  },
  {
    ...
    bookingHref: "/bestill-time?behandler=christina",
    hvaEr: [
    ...
    passerFor: [
      ...
      "Deg med korte vipper — den koreanske teknikken tar tak i hvert enkelt hår, og gir løft også når det er lite å jobbe med",
      "Deg som vil ha et våkent blikk uten vippeextensions",
      "Deg som bruker vippetang hver morgen og vil slippe det",
      "Deg som har hatt extensions og vil gi dine egne vipper en pause",
    ...
    forlop: [
      ...
      { tittel: "Under", tekst: "Du ligger med lukkede øyne hele tiden. Vippene legges på en silikonform tilpasset lengden din, og festes hår for hår. Deretter virker løftemiddelet, før vippene fikseres og næres. Til slutt farges vippene — det er inkludert i prisen." },
      { tittel: "Etter", tekst: "Hold vippene tørre i 24 timer — ingen vann, damp, badstue, trening eller sminke i øyeområdet. Etterpå lever du som vanlig. Ikke bruk maskara det første døgnet, og unngå å sove med ansiktet ned i puten de første nettene. Vippetangen kan du legge bort helt — den vil bare knekke løftet." },
    ],
    ...
    faq: [
      ...
      { q: "Funker det på korte vipper?", a: "Ja. Den koreanske teknikken fester vippene hår for hår, og løfter fra rotpartiet — derfor får den godt tak også på korte vipper. Er du usikker på om du har nok å jobbe med, si fra når du booker, så ser vi på det i starten av timen." },
  ...
  },
  {
    ...
    holdbarhet: "Vedlikeholdsbehandling anbefales hver 6. måned",
    hvaEr: [
    ...
    resultat: "Bedre fuktbalanse merkes gjerne etter en ukes tid. Den egentlige effekten — fastere, jevnere hud — kommer gradvis over 4–8 uker etter andre behandling, når kollagenproduksjonen har kommet i gang. For å holde på effekten anbefaler vi vedlikeholdsbehandling hver sjette måned.",
    faq: [
      ...
      { q: "Hvor mange behandlinger trenger jeg?", a: "Standardkuren er to behandlinger med fire ukers mellomrom. Deretter anbefaler vi vedlikeholdsbehandling hver sjette måned." },
  ...
  },
  {
    ...
    hvaEr: [
      "Profhilo Structura er en videreutvikling av klassisk Profhilo som jobber dypere — i laget der ansiktets fettputer ligger. Der klassisk Profhilo jobber med hudkvaliteten, retter Structura seg mot underlaget huden hviler på.",
    ...
    forlop: [
      ...
      { tittel: "Under", tekst: "Området renses, og produktet injiseres med kanyle. Det finnes to ulike protokoller, og vi vurderer på timen hvilken som passer deg best. Resten av timen går til vurdering og informasjon." },
    ...
    faq: [
      { q: "Hva er forskjellen på Structura og vanlig Profhilo?", a: "De jobber i hvert sitt lag. Klassisk Profhilo virker rett under huden, med fuktighet, fasthet og hudkvalitet. Structura jobber dypere, i fettlaget, og retter seg mot støtten og konturene i ansiktet." },
      ...
      { q: "Kan jeg kombinere med klassisk Profhilo?", a: "Ja, de utfyller hverandre — klassisk Profhilo på hudkvaliteten, Structura på støtten under. Vi setter opp en rekkefølge som passer deg." },
      { q: "Gjør det vondt?", a: "Noen kjenner mer trykk enn ved klassisk Profhilo. De fleste beskriver det likevel som godt overkommelig, og vi kan bruke bedøvelseskrem." },
    ],
  ...
  },
  {
    ...
    pris: "3.000,-",
    varighet: "Ca. 45 minutter",
    antall: "Én behandling, eller kur på 2–3 med 4 ukers mellomrom",
    holdbarhet: "Vedlikeholdsbehandling 1–2 ganger i året",
    hvaEr: [
      "Viscoderm Hydrobooster er hyaluronsyre laget for områder som er i stadig bevegelse — rundt munnen, ved øynene, i pannen og på halsen. Den settes overfladisk i huden.",
      ...
      "Noen har behov for én behandling, mens andre trenger en kur på to til tre behandlinger med fire ukers mellomrom. Deretter anbefaler vi vedlikeholdsbehandling én til to ganger i året.",
    ],
    passerFor: [
    ...
    forlop: [
      ...
      { tittel: "Under", tekst: "Huden renses og kan bedøves med krem. Produktet settes overfladisk med svært tynn nål." },
    ...
    resultat: "Huden kjennes mer fuktet etter få dager. Selve utglattingen av linjene kommer gradvis, og vurderes best noen uker etter siste behandling.",
    faq: [
      ...
      { q: "Hvor mange behandlinger trenger jeg?", a: "Det varierer. Noen har behov for én behandling, mens andre trenger en kur på to til tre behandlinger med fire ukers mellomrom. Deretter anbefaler vi vedlikeholdsbehandling én til to ganger i året. Vi vurderer det sammen på timen." },
